    ...
    <div class="bg-white  mt-8 mx-auto px-16 py-8 rounded-lg shadow-2xl">
        ...
        <form class="my-8 text-sm" method="POST" action="{{ route('register') }}">
            ...
            <div class="flex flex-col my-4">
                <label for="firstname" class="text-gray-700">{{ __('Voornaam') }}</label>
            ...
            <div class="flex flex-col my-4">
                <label for="lastname" class="text-gray-700">{{ __('Achternaam') }}</label>
            ...
            <div class="flex flex-col my-4">
                ...
                <div class="flex">
                    <select id="country" class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-500 bg-gray-50 border border-gray-300 rounded-l-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600">
                        ...
                        <option value="31" class="inline-flex w-full px-4 py-2 bg-gray-50 hover:bg-gray-100">
                            <div class="w-4 h-8">🇳🇱 </div>(+31)
                        </option>
                        <option value="32" class="inline-flex w-full px-4 py-2 bg-gray-50 hover:bg-gray-100">
                            <div class="w-4 h-8">🇧🇪 </div>(+32)
                        </option>
                    </select>
            ...
            <div class="flex flex-col my-4">
                <label for="password" class="text-gray-700">{{ __('Herhaal wachtwoord') }}</label>
                <div x-data="{ show: false }" class="relative flex items-center mt-2">
                    <input :type=" show ? 'text': 'password' " id="password" type="password" name="password_confirmation" required class="form-control @error('password_confirmation') is-invalid @enderror flex-1 p-2 pr-10 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900">
                    <button @click="show = !show" type="button" class="absolute right-2 bg-transparent flex items-center justify-center text-gray-700">
                        <svg x-show="!show" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"></path>
                        </svg>
            ...
            <div class="flex items-center">
                <input type="checkbox" name="accept" id="accept" class="mr-2 focus:ring-0 rounded">
                <label for="accept" class="text-gray-700">Ik accepteer <a href="{{ route('privacy') }}" class="text-blue-600 hover:text-blue-700 hover:underline">het privacybeleid</a></label>
            </div>
