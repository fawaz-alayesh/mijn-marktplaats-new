    ...
    <form class="mt-8 space-y-3" action="/advertentie/{{ $ad->slug }}" method="POST" enctype="multipart/form-data" runat="server">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 space-y-2">
                ...
                <select class="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500" type="" name="category">
                    <option name="category" value="{{ $ad->category->id}}" selected>{{ $ad->category->name}}</option>
