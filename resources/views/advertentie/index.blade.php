...
@section('content')
          ...
          <!-- advertenties -->
          <main class="py-2 px-2 w-full xl:w-3/4 md:w-2/3 sm:p-6 md:py-2 md:px-2 ">
          ...
          <div data-tooltip-target="tooltip-bottom" data-tooltip-placement="bottom" id='remove-directions' class="bg-neutral-50 hover:bg-gray-200 absolute right-0 bottom-4 w-8 h-8 cursor-pointer z-10 flex items-center justify-center rounded-lg m-2 border-solid border-2 "> <img src="src/direction(1).png" alt=""></div>
           <div id="tooltip-bottom" role="tooltip" class="inline-block z-10 py-2 px-3 text-sm font-medium text-white bg-zinc-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
             <ul>
              <li>1.Activeer direction: Klik eerst <br><div class="flex flex-row"><div>op het button </div><div class="bg-white w-6 h-6 ml-2 cursor-pointer  z-10 flex items-center justify-center shadow rounded-lg  border-solid border-2 border-indigo-60"> <img  src="src/direction(1).png" alt=""></div></div></li>
              <li>2.klik op twee verschillende plaatsen</li>
              <li>3.Kijk direction tips, Tijd en afstand</li>
              <li>* Om de Navigatie uit te schakelen Klik weer <br><div class="flex flex-row"><div>op het button </div><div class="bg-white w-6 h-6 ml-2 cursor-pointer  z-10 flex items-center justify-center shadow rounded-lg  border-solid border-2 border-indigo-60"> <img  src="src/direction(1).png" alt=""></div></div></li>
             </ul>
   ...
   el.style.backgroundSize = "100%";
    ...
    new mapboxgl.Marker(el)
       ...
       //toggel direction
        ...
        var directionsElement = document.getElementById("remove-directions")
